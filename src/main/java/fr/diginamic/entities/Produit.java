...
public class Produit {
    ...
    private float presenceHuileDePalme;
    ...
    public float getPresenceHuileDePalme() {
        return presenceHuileDePalme;
    }

    public void setPresenceHuileDePalme(float presenceHuileDePalme) {
        this.presenceHuileDePalme = presenceHuileDePalme;
    }
    ...
    public void checkIngredients() throws Exception {
        if (this.ingredients.isEmpty()) {
            throw new Exception("Un produit doit avoir au moins 1 ingrédient associé");
        }
    }
